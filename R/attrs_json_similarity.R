...
full <- rbind(train[, c("itemID", "attrsJSON"), with=FALSE],
              test[, c("itemID", "attrsJSON"), with=FALSE])
...
write_csv(trainNew, "../Data/oleksii_attrsJSON_features_train.csv")
write_csv(testNew, "../Data/oleksii_attrsJSON_features_test.csv")